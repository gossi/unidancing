...
export class ChoreographyUniDanceWritingRoute extends Route<{}> {
  <template>
    ...
    <p>Der Begriff
      <b>Choreographie</b>
      bedeutet wörtlich "Tanz-Schreiben" und leitet sich aus dem griechischen ”χορεία” (khorós = Tanz)
      und ”γραφή” (gráphō = schreiben) ab. Im Tanzen haben sich unter dem Begriff
      <i>Dance Writing</i>
